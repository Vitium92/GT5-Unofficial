...
public class GT_FuelLoader
    ...
    public void run() {
        ...
        RecipeMaps.smallNaquadahReactorFuels.add(
        ...
        RecipeMaps.largeNaquadahReactorFuels.add(
            GT_Values.RA.stdBuilder()
                .itemInputs(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.NaquadahEnriched, 1L))
                .itemOutputs(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Naquadah, 1L))
                .duration(0)
                .eut(200000)
        );
        RecipeMaps.fluidNaquadahReactorFuels.add(
            GT_Values.RA.stdBuilder()
