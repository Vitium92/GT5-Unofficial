...
public class GT_MetaTileEntity_Centrifuge_Steel
        extends GT_MetaTileEntity_BasicMachine_Steel {
    public GT_MetaTileEntity_Centrifuge_Steel(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional, "Separating Molecules", 2, 6, false, 64000);
    }

    public GT_MetaTileEntity_Centrifuge_Steel(String aName, String aDescription, ITexture[][][] aTextures) {
    ...
    public Object getClientGUI(int aID, InventoryPlayer aPlayerInventory, IGregTechTileEntity aBaseMetaTileEntity) {
        return new GT_GUIContainer_BasicMachine(aPlayerInventory, aBaseMetaTileEntity, getLocalName(), "SteelCentrifuge.png", GT_Recipe.GT_Recipe_Map.sCentrifugeRecipes.mUnlocalizedName);
    }
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntity_Centrifuge_Steel(this.mName, this.mDescriptionArray, this.mTextures);
    }

    public int checkRecipe() {
        GT_Recipe tRecipe = GT_Recipe.GT_Recipe_Map.sCentrifugeRecipes.findRecipe(getBaseMetaTileEntity(), mLastRecipe, false, V[2], new FluidStack[]{getFillableStack()}, getSpecialSlot(), getAllInputs());
